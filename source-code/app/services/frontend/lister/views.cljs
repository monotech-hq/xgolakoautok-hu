  ...
  (let [timestamp @(r/subscribe [:activities/get-actual-timestamp modified-at])]
       [common/list-item-structure lister-id item-dex
                                   {:cells [[common/list-item-thumbnail-icon lister-id item-dex {:icon :workspace_premium}]
                                            [common/list-item-label          lister-id item-dex {:content name :stretch? true :placeholder :unnamed-service}]
...
(defn- breadcrumbs
  []
  (let [lister-disabled? @(r/subscribe [:item-lister/lister-disabled? :services.lister])]
       [common/surface-breadcrumbs :services.lister/view
...
(defn- label
  []
  (let [lister-disabled? @(r/subscribe [:item-lister/lister-disabled? :services.lister])]
       [common/surface-label :services.lister/view
                             {:disabled? lister-disabled?
                              :label     :services}]))
