...
(ns app.models.frontend.picker.views
    (:require [app.models.frontend.picker.prototypes :as picker.prototypes]
...
(defn- model-picker-button
  ...
  (let [on-click [:models.selector/load-selector! :models.selector picker-props]]
