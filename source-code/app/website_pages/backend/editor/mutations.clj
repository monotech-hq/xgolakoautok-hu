...
(ns app.website-pages.backend.editor.mutations
    (:require [app.common.backend.api                      :as common]
              [app.website-pages.backend.editor.prototypes :as editor.prototypes]
...
(defn add-item-f
  ...
  (if (x.user/request->authenticated? request)
      (letfn [(prepare-f [document] (->> document (common/added-document-prototype request)
             ...
             (mongo-db/save-document! "website_pages" item {:prepare-f prepare-f}))))
...
(defmutation add-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'website-pages.editor/add-item!}
...
(defmutation save-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'website-pages.editor/save-item!}
