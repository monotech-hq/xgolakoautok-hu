...
(ns app.vehicle-categories.backend.viewer.mutations
...
(defmutation undo-delete-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'vehicle-categories.viewer/undo-delete-item!}
...
(defmutation duplicate-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'vehicle-categories.viewer/duplicate-item!}
