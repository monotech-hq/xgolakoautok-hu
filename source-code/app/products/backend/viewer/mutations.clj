...
(ns app.products.backend.viewer.mutations
...
(defmutation delete-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'products.viewer/delete-item!}
...
(defmutation undo-delete-item!
             ...
             ; @return (namespaced map)
             [env mutation-props]
             {::pathom.co/op-name 'products.viewer/undo-delete-item!}
...
(defmutation duplicate-item!
             ...
             ; @return (string)
             [env mutation-props]
             {::pathom.co/op-name 'products.viewer/duplicate-item!}
